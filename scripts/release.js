...
// Git operations
try {
  // Check if there are uncommitted changes besides package.json
  ...
  // Note: execSync is safe here — no user input is interpolated into commands.
  // The only dynamic value (newVersion) is derived from package.json's semver string.
